  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your mentor application has been submitted for review. You'll be notified once it's processed.",
      });
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Share your knowledge and experience with the next generation. Fill out this application to become a verified mentor.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="availability">Monthly Availability (hours)</Label>
                  <Input
                    id="availability"
                    type="number"
                    min="0"
                    value={monthlyAvailability}
                    onChange={(e) => setMonthlyAvailability(parseInt(e.target.value) || 0)}
                    placeholder="e.g., 20"
                    required
                  />
                </div>
